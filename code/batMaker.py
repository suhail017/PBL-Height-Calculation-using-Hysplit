...
class Bat(object):
	def __init__(self, spatial, dur, filePrefix):	
		self.basePath = "C:\\hysplit4\\working\\"		# set this once
		self.jobfile = "..\working\hysplitjob_2011.lst" # this gets over ridden
		self.loc = spatial 							
		self.dur = dur								
		self.numEdas = 2							
		self.edasPath = "X:/DATA/edasDataFiles/"	# EDAS input file path
		self.controlPath = "C:/hysplit4/working/"	# place where control file will be placed
		self.savePath = "./"
	...
	def callHysplit(self):
		...
		os.system('C:/hysplit4/working/win.bat')				
